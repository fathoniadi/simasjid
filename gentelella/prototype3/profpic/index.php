...
<head>
  ...
  <title>ProfPic Schematics 2016</title>
...
<div class="background">
  <div class="container" id="crop-avatar">
    ...
    <!-- Current avatar -->
    <div class="avatar-view" title="Click to edit">
        ...
        <div class="modal-content">
          <form class="avatar-form" action="crop.php" enctype="multipart/form-data" method="post">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="avatar-modal-label">Croping image</h4>
            </div>
            <div class="modal-body">
              <div class="avatar-body">
                ...
                <div class="row avatar-btns">
                  ...
                  <div class="col-md-3">
                    <button type="submit" style="margin:0px; background-color: #d62f40; border-color: white; color: white;" class="buttonDownload">Done</button>
                  </div>
                </div>
              </div>
            </div>
